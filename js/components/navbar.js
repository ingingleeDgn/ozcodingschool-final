export function renderNavbar(container) {
  container.innerHTML = `
    <nav class="navbar">
      <a href="#home" class="nav-item" data-hash="#home">
        <div class="nav-icon">
          <!-- Home Icon SVG -->
      ...
      <a href="#history" class="nav-item" data-hash="#history">
        <div class="nav-icon">
          <!-- Calendar/History Icon SVG -->
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
        </div>
        <span>히스토리</span>
      </a>
      <a href="#criteria" class="nav-item" data-hash="#criteria">
        <div class="nav-icon">
          <!-- Criteria/Settings Icon SVG -->
...
export function updateNavbarActive(hash) {
  const currentHash = hash === '' ? '#home' : hash;
